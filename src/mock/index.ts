...
// ============ 认证相关 Mock ============
// 【已禁用】登录 /api/auth/login — 交由后端处理
// 【已禁用】退出 /api/auth/logout — 交由后端处理
// 【已禁用】获取当前用户 /api/auth/me — 交由后端处理
// 【已禁用】验证码登录 /api/auth/login/code — 交由后端处理
// 【已禁用】发送验证码 /api/auth/code — 交由后端处理
// 【已禁用】注册 /api/auth/register — 交由后端处理

// ============ 用户相关 Mock ============
// 【已禁用】获取用户信息 /api/user/info — 交由后端处理（需返回当前登录用户而非假数据）
// 【已禁用】更新用户信息 /api/user/info — 交由后端处理

// 【已禁用】修改密码 /api/user/password — 交由后端处理
